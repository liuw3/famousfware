...
class CategoryImage extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(DataObject $row)
    {
        ...
        if ($value) {
            ...
            $width = 50;
            $height = 50;
            return "<img src='".$src.'cat_image'.$value."' width=".$width." height=".$height." alt='No Image Avialable'/>";
        } else {
