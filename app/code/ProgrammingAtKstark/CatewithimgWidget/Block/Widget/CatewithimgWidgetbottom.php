...
class CatewithimgWidgetbottom extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
	protected $_template = 'widget/categorywidgetbottom.phtml';
   ...
   public function getCategoryCollection()
    {
     // echo "<pre>";
       // print_r($this->getData());exit();
        $cat = explode("/",$this->getData('id_path'));
        if(isset($cat)){
            $id = $cat[1];
        }
        if(!isset($id)){
