...
class SliderItemmobile extends \Magento\Framework\View\Element\Template
{
    ...
    const STYLESLIDE_FLEXSLIDER_TEMPLATE1 = 'Magestore_Bannerslider::slider/flexslidermobile.phtml';
    ...
    {
       // echo "styleslideid=".$styleSlideId;
        switch ($styleSlideId) {
            //Evolution slide
    ...
    public function setSlider(\Magestore\Bannerslider\Model\Slider $slider)
    {
     ...
     public function setMobileSlider(\Magestore\Bannerslider\Model\Slider $slider)
    {
        $this->_mobileslider = $slider;
